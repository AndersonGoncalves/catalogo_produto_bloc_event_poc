...
Esse app utiliza o Bloc para gerenciar estados utilizando Event.
...
1. *Clone este repositório*
   bash
   git clone https://github.com/AndersonGoncalves/catalogo_produto_bloc_event_poc.git
   cd catalogo_produto_bloc_event_poc   
